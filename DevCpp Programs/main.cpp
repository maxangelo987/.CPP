...
class activity2
{
      public:
             ...
             long long q,q1,q2;
             long long bil,hmil,rmil,tmil,omil,hthou,rthou,tthou,othou,h,r,t,o;
...
void activity2::convert() // This class is for converting Nummbers to Words
{   
bil=num/1000000000;
num=num%1000000000;
hmil=num/100000000;
...
void activity2::decision()
{
if (count!=0)
{
//cout<<"You can't Enactivity2"; 
for (j=0;j<w;j++)
    {
...
//cout<<". It contains letter O. "<<endl;
}
...
// cout<<".";
 cout<<endl;
//cout<<"It doesn't contain letter O. "<<endl;
 }
